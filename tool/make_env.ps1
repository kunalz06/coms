...
$flutterEnv = [ordered]@{
  ...
  API_BASE_URL = $envValues["NEXT_PUBLIC_APP_URL"]
  WS_BASE_URL = $envValues["NEXT_PUBLIC_SIGNALING_URL"]
  ...
  VAPID_PUBLIC_KEY = $envValues["NEXT_PUBLIC_VAPID_PUBLIC_KEY"]
  FCM_WEB_VAPID_KEY = $envValues["FCM_WEB_VAPID_KEY"]
